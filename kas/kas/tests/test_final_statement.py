...
class DeductionTest(TestCase):
    ...
    def test_generate_final_taxslip(self):
        ...
        person = Person.objects.create(cpr='0102031234', name='Test Testperson', municipality_code=956, municipality_name='Sermersooq',
                                       address_line_2='Testvej 42', address_line_4='1234  Testby')
        ...
        pension_company1 = PensionCompany.objects.create(res=12345671, name='P+, Pensionskassen for Akademikere')
        pension_company2 = PensionCompany.objects.create(res=12345672, name='PFA', agreement_present=True)
        pension_company3 = PensionCompany.objects.create(res=12345673, name='High Risk Invest & Pension')
