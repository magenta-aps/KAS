...
class PersonTaxYearSerializer(serializers.ModelSerializer):
    ...
    person = serializers.SlugRelatedField(
        queryset=Person.objects.all(), slug_field="cpr"
    )
    tax_year = serializers.SlugRelatedField(
        queryset=TaxYear.objects.all(), slug_field="year"
    )


class PolicyDocumentSerializer(serializers.ModelSerializer):
    def create(self, validated_data):
        validated_data["person_tax_year_id"] = validated_data[
            "policy_tax_year"
        ].person_tax_year_id
    ...
    policy_tax_year = serializers.PrimaryKeyRelatedField(
